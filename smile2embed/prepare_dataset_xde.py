...
def smile2embedding(smile_list, model_dir, use_gpu=True, num_cpus=12):
    ...
    descriptors = infer_model.seq_to_emb(smile_list)
    print("similes embedding dataset shape ", descriptors.shape)
...
def featurize_dataset(csvfile, output_file="output", dataset_prefix="data", fasta_dir="fastas"):
    ...
    SmileEmbeddingDataset(root=dataset_prefix, dataset=output_file, xd=train_drugs,
                          xde=drug_embedding,
